class Solution:
    def minWindow(self, s: str, t: str) -> str:
        ...
        left = 0
        chars = {} # only the chars in original_freq
        ...
        for right in range(left, len(s)):
            ...
            if s[right] in original_freq:
                ...
                if chars[s[right]] == original_freq[s[right]]:
                    have += 1
            ...
            while have == need:
                ...
                # by definition, s[left] is in chars and original_freq
                # since we start our left window only
                # with a char in t
                chars[s[left]] -= 1
                if chars[s[left]] < original_freq[s[left]]:
                    have -= 1
                left += 1

                # move to next position where char in original_freq
